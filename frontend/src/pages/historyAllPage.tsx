...
export const HistoryAllPage = () => {
    const history2021 = [
        ...
        {historyAge: "2021.10", historyContent: "HacU Meijo参加"},
    ...
    const history2022 = [
        ...
        {historyAge: "2022.10", historyContent: "JPHACKS参加"},
        {historyAge: "2022.11", historyContent: "XRCreativeAward参加"},
        {historyAge: "2022.11", historyContent: "技育CAMPハッカソンvol8　努力賞受賞"},
        {historyAge: "2022.12", historyContent: "HackU Meijo参加"},
        {historyAge: "2022.12", historyContent: "WithARハッカソン参加"},
        {historyAge: "2022.12", historyContent: "学生団体SAIBASIに運営として加入"},
    ]
